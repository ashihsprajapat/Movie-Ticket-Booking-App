...
function MovieCard({ movie }) {
    ...
    return (
        <div>
            ...
            <div class="p-4border bg-gray-700 rounded-lg shadow-sm max-w-80 cursor-pointer w-96 pt-3 pb-5 p-2 ">
                <img class="rounded-md max-h-60 w-full p-1 object-cover" src={movie.poster_path} alt="officeImage"
